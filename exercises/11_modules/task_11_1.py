...
#     parse_cdp = command_output.split('\n')
#     hostname = ''
#     result = {}
#     for line in parse_cdp:
#         if '>' in line:
#             hostname = line[0:line.find('>')]
#             print(hostname)
#         elif 'Eth' in line:
#             parse_cdp_2 = line.split()
#             remote_dev = parse_cdp_2[0]
#             remote_port = parse_cdp_2[-2]+parse_cdp_2[-1]
#             local_port = parse_cdp_2[1]+parse_cdp_2[2]
#             key = (hostname, local_port)
#             value = (remote_dev, remote_port)
#             result[key] = value
#     return result
