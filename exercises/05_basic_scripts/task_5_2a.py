...
ip_net_bin = ip_adr_bin[0:int(ip_pref[1])] + ('0' * (32 - int(ip_pref[1])))
ip_net = [int(ip_net_bin[0:8], 2), int(ip_net_bin[8:16], 2), int(ip_net_bin[16:24], 2), int(ip_net_bin[24:], 2)]

ip_mask = ('1' * int(ip_pref[1])) + ('0' * (32 - int(ip_pref[1])))

template = f'''
Network:
{ip_net[0]:<10}{ip_net[1]:<10}{ip_net[2]:<10}{ip_net[3]:<10}
{ip_net_bin[0:8]:<10}{ip_net_bin[8:16]:<10}{ip_net_bin[16:24]:<10}{ip_net_bin[24:]:<10}
